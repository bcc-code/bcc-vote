...
describe('permissions - app ability', async () => {
  ...
  const useCases:Array<useCaseType> = [
      ...
      { action:"find", subject:"polling-event", activeRole:"OrgRepresentative", entity:'scopedToRepresentativesEvent', expected: true },
      { action:"find", subject:"polling-event", activeRole:"Member", entity:'scopedToRepresentativesEvent', expected: false },
      ...
      { action:"get", subject:"polling-event", activeRole:"OrgRepresentative", entity:'scopedToRepresentativesEvent', expected: true },
      { action:"get", subject:"polling-event", activeRole:"Member", entity:'scopedToRepresentativesEvent', expected: false },
